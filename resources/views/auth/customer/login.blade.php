...
<head>
    ...
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('customers/app-assets/css/vendor.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('customers/app-assets/css/switchery.min..css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('customers/app-assets/css/switch.min..css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('customers/app-assets/css/palette.min.css') }}">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('customers/theme-assets/css/bootstrap-extended.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('customers/theme-assets/css/colors.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('customers/app-assets/css/components.min.css') }}">
    <!-- END: Theme CSS-->

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('customers/app-assets/css/vertical-menu.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('customers/theme-assets/css/core/colors/palette-gradient.min.css0') }}">
